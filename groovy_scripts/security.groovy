...
def adminUser = security.addUser('test.user', 'Test', 'User', 'test@test.com', true, 'admin456', adminRole)
log.info('User TEST created')
...
user.setEmailAddress('rchauhan@qa.com')
security.securitySystem.updateUser(user)
security.securitySystem.changePassword('admin','admin!23')
